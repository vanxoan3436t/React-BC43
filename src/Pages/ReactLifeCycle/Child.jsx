...
/*
  ...
  Tuy nhiên sự so sánh props có thay đổi hay không chỉ là shallow compare (so sánh được những giá trị primitive(nguyên thủy) value string, boolean , number, undefined, null).
*/
